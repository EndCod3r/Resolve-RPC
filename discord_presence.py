...
class DiscordPresence:
    ...
    def reconnect(self):
        ...
        if self.reconnect_attempts >= self.max_reconnect_attempts:
            print(f"Max reconnection attempts ({self.max_reconnect_attempts}) reached. Giving up for now.")
            return False
        
        self.reconnect_attempts += 1
        print(f"Attempting to reconnect to Discord (attempt {self.reconnect_attempts}/{self.max_reconnect_attempts})...")
    ...
    def _format_presence(self, project, timeline, page):
        ...
        if page == "starting" or project == "Starting..." or timeline == "Loading..." or project == "Unknown":
            return {
        ...
        if not timeline or timeline == "None" or timeline == "No Timeline Open" or timeline == "Loading...":
        ...
        show_timer = project not in ["Untitled Project", "Starting...", "Loading...", "Unknown", "In Menus"]
