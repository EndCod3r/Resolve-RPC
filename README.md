...
If you want the script to run when DaVinci Resolve starts up move the `discord-rpc` folder to one of the `Fuses` folders.
You can find one of the folders by:
